...
students= ['Amir Tawfik', 'Anthony Narisi','David Lin','Elizabeth Lefever','Emilia Friedberg','Gabriel Mahan', 'Marcoa Martinez', 'Myra Orgain', 'Neill Perry', 'Peter Duke','Wolfgang Criollo']
# 'Walter Chabla','Yossi Ruben','Nicholas Wang']
...
Cohort.last.students[1].pitches.create(title: 'What next?', description:'Synth literally tumblr portland brunch, paleo next level chillwave normcore. Organic man bun yuccie, quinoa activated charcoal skateboard humblebrag meggings post-ironic pork belly. Thundercats iPhone man braid, edison bulb venmo health goth kogi poutine lo-fi flexitarian roof party +1 kombucha post-ironic blog.')
...
Cohort.last.students[5].pitches.create(title: 'Find my Car', description:'Synth literally tumblr portland brunch, paleo next level chillwave normcore. Organic man bun yuccie, quinoa activated charcoal skateboard humblebrag meggings post-ironic pork belly. Thundercats iPhone man braid, edison bulb venmo health goth kogi poutine lo-fi flexitarian roof party +1 kombucha post-ironic blog.')
...
Cohort.last.students[6].pitches.create(title: 'We live', description:'Synth literally tumblr portland brunch, paleo next level chillwave normcore. Organic man bun yuccie, quinoa activated charcoal skateboard humblebrag meggings post-ironic pork belly. Thundercats iPhone man braid, edison bulb venmo health goth kogi poutine lo-fi flexitarian roof party +1 kombucha post-ironic blog.')
